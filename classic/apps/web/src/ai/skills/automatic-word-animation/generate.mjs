...
const output = `// Generated from SKILL.md by generate.mjs; do not edit.\nexport const AUTOMATIC_WORD_ANIMATION_SKILL = ${JSON.stringify(content)};\n`;
const path = new URL("./runtime.generated.ts", import.meta.url);
if (process.argv.includes("--check")) {
 if (await readFile(path,"utf8") !== output) throw new Error("Automatic Word Animation skill projection is stale");
