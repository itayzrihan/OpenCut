...
const output = `// Generated from SKILL.md by generate.mjs; do not edit.\nexport const AUTOMATIC_TEXT_TRANSITIONS_SKILL = ${JSON.stringify(content)};\n`;
const path = new URL("./runtime.generated.ts", import.meta.url);
if (process.argv.includes("--check")) {
 if (await readFile(path,"utf8") !== output) throw new Error("Automatic Transitions skill projection is stale");
